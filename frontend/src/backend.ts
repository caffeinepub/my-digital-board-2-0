...
export class Backend implements backendInterface {
    ...
    async getAllBoardStates(): Promise<Array<[string, BoardState]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBoardStates();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getBoardState(arg0: string): Promise<BoardState> {
        if (this.processError) {
            try {
    ...
    async updateBoardState(arg0: string, arg1: BoardState): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBoardState(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
